...
SET(FAISS_LIBRARY ${FAISS_BUILD_DIR}/faiss/libfaiss.so)
FIND_LIBRARY(OPENMP_LIBRARY REQUIRED
    NAMES libgomp.so.1 omp
...
ExternalProject_Add(
  ...
  CMAKE_ARGS -DFAISS_ENABLE_GPU=OFF -DFAISS_ENABLE_RAFT=OFF -DFAISS_ENABLE_PYTHON=OFF -DFAISS_ENABLE_C_API=OFF -DBUILD_TESTING=OFF -DBUILD_SHARED_LIBS=ON -DFAISS_OPT_LEVEL=generic -DRAFT_NVTX=OFF -DCMAKE_CUDA_ARCHITECTURES="NATIVE" -DOpenMP_CXX_LIB_NAMES=libomp -DOpenMP_libomp_LIBRARY=${OPENMP_LIBRARY} -DOpenMP_CXX_INCLUDE_DIR=/usr/lib/gcc/x86_64-linux-gnu/13/include -DBLAS_LIBRARIES=${BLAS_LIBRARIES}
