...
bool allow_binlog_writes_on_raft_follower = 0;
...
ulong opt_replica_compression_lib = 0;
...
/* Lock to protect full_sql_text map structure */
mysql_mutex_t LOCK_full_sql_text;
...
bool update_table_create_timestamp_on_truncate = false;
...
/* Comma separated list of sql ids to store full sql text for */
char *full_sql_ids = nullptr;
...
#endif
{
  ...
  */
  ...
  db_ac->update_queue_low_pri_sql_ids(admission_control_low_pri_sql_ids);
...
static PSI_thread_info all_server_threads[]=
{
  ...
  { &key_thread_handle_slave_stats_daemon, "slave_stats_daemon", "slave_stat", PSI_FLAG_SINGLETON, 0, PSI_DOCUMENT_ME},
...
bool set_thread_priority(char *thread_priority_cptr) {
  if (thread_priority_cptr == nullptr) return true;
