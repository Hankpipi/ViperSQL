...
simple_statement:
        ...
        | use                           { $$= nullptr; }
        | xa                            { $$= nullptr; }
        | sync_statement /* add sync */
        ;

sync_statement:
          any_sql_stmt SYNC_SYM time_units
          {
            $$ = new PT_sync_stmt($1, $3);
          }
        ;
...
time_unit:
          ulong_num YEAR_SYM    { $$ = 365L * 24 * 3600 * $1; }
        | ulong_num MONTH_SYM   { $$ = 30L * 24 * 3600 * $1; }
        | ulong_num WEEK_SYM    { $$ = 7L * 24 * 3600 * $1; }
        | ulong_num DAY_SYM     { $$ = 24L * 3600 * $1; }
        | ulong_num HOUR_SYM    { $$ = 3600 * $1; }
        | ulong_num MINUTE_SYM  { $$ = 60 * $1; }
        | ulong_num SECOND_SYM  { $$ = $1; }
        ;
