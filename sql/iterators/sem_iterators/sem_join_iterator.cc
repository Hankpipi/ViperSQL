...
#include "sql/iterators/sem_iterators/sem_join_iterator.h"
...
// class SemJoinTemplateIterator final : public TableRowIterator {
//  public:
//   SemJoinTemplateIterator(
...
// */
// template <typename Profiler>
// bool SemJoinTemplateIterator<Profiler>::move_table_to_disk(int error_code,
//                                                               bool was_insert) {
...
// template <typename Profiler>
// SemJoinTemplateIterator<Profiler>::SemJoinTemplateIterator(
//     THD *thd, unique_ptr_destroy_only<RowIterator> subquery_iterator,
//     Temp_table_param *temp_table_param, TABLE *table,
//     unique_ptr_destroy_only<RowIterator> table_iterator, JOIN *join,
//     int ref_slice)
...
// template <typename Profiler>
// bool SemJoinTemplateIterator<Profiler>::Init() {
...
// template <typename Profiler>
// int SemJoinTemplateIterator<Profiler>::Read() {
//   const typename Profiler::TimeStamp start_time = Profiler::Now();
...
// RowIterator *sem_join_template_iterator::CreateIterator(
//     THD *thd, unique_ptr_destroy_only<RowIterator> subquery_iterator,
//     Temp_table_param *temp_table_param, TABLE *table,
//     unique_ptr_destroy_only<RowIterator> table_iterator, JOIN *join,
//     int ref_slice) {
